...
$query   = "INSERT into RECRUIT(NAME,EMAIL,PHONE,COLLEGE,YEAR,FPRE,SPRE)
    VALUES('" . $name . "','" . $email . "','" . $phone . "','" . $college . "','" . $year . "','" . $fpre . "','" . $spre . "')";
...
<head>
    ...
    <title>IEEE ASU SB Recruitment</title>
...
<div class="col-md-4">
<h2>
You Registered Successfully,we will contact you to prepare the Interview Date.
for any complaints or editing in registration Personal Information please contact us through the contact form or our fan Pages below.
</h2>
</div>
</div>
<div class="col-md-4"></div>
